...
switch (val.requestType) {
  ...
  function sendRequest() {
    ...
    /*
    const url =
    `request_handler.php?endpoint=${encodeURIComponent(endpoint)}&type=${requestType}&content=${userResponse}&msisdn=${msisdn}&network=${network}&sessionID=${sessionID}`;
    ...
    */
     ...
     * currentRequest = $.post("request_handler.php", data);
     */
